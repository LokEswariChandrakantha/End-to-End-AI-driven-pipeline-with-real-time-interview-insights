...
from openai import OpenAI  # Ensure your OpenAI library supports this usage
    ...
    def search(
        ...
        Args:
            ...
            predicates: A Predicates object for complex metadata filtering.
                ...
                - Operators: ==, !=, >, >=, <, <=.
                - Use '&' to combine multiple predicates with the AND operator.
                - Use '|' to combine multiple predicates with the OR operator.
